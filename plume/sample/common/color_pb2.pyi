...
class ColorGradient(_message.Message):
    ...
    class AlphaKey(_message.Message):
        ...
        time: float
        def __init__(
            self, alpha: _Optional[float] = ..., time: _Optional[float] = ...
        ) -> None: ...
    ...
    color_keys: _containers.RepeatedCompositeFieldContainer[
        ColorGradient.ColorKey
    ]
    alpha_keys: _containers.RepeatedCompositeFieldContainer[
        ColorGradient.AlphaKey
    ]
    def __init__(
        self,
        color_space: _Optional[_Union[ColorSpace, str]] = ...,
        mode: _Optional[_Union[ColorGradient.GradientMode, str]] = ...,
        color_keys: _Optional[
            _Iterable[_Union[ColorGradient.ColorKey, _Mapping]]
        ] = ...,
        alpha_keys: _Optional[
            _Iterable[_Union[ColorGradient.AlphaKey, _Mapping]]
        ] = ...,
    ) -> None: ...
