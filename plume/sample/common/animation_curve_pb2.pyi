...
class AnimationCurve(_message.Message):
    ...
    keyframes: _containers.RepeatedCompositeFieldContainer[
        AnimationCurveKeyFrame
    ]
    def __init__(
        self,
        keyframes: _Optional[
            _Iterable[_Union[AnimationCurveKeyFrame, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class AnimationCurveKeyFrame(_message.Message):
    ...
    def __init__(
        ...
        in_tangent: _Optional[float] = ...,
        out_tangent: _Optional[float] = ...,
        weighted_mode: _Optional[_Union[WeightedMode, str]] = ...,
        in_weight: _Optional[float] = ...,
        out_weight: _Optional[float] = ...,
    ) -> None: ...
