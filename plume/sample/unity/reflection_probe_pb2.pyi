...
from plume.sample.common import bounds_pb2 as _bounds_pb2
...
class ReflectionProbeUpdate(_message.Message):
    __slots__ = ("component", "enabled", "mode", "refresh_mode", "time_slicing_mode", "clear_flags", "importance", "intensity", "near_clip_plane", "far_clip_plane", "render_dynamic_objects", "box_projection", "blend_distance", "bounds", "resolution", "hdr", "shadow_distance", "background_color", "culling_mask", "custom_baked_texture", "baked_texture")
    COMPONENT_FIELD_NUMBER: _ClassVar[int]
    ...
    CUSTOM_BAKED_TEXTURE_FIELD_NUMBER: _ClassVar[int]
    BAKED_TEXTURE_FIELD_NUMBER: _ClassVar[int]
    component: _identifiers_pb2.ComponentIdentifier
    enabled: bool
