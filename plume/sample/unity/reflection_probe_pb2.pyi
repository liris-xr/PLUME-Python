...
class ReflectionProbeClearFlags(
    ...
    REFLECTION_PROBE_CLEAR_FLAGS_SOLID_COLOR: _ClassVar[
...
class ReflectionProbeRefreshMode(
    ...
    __slots__ = ()
    REFLECTION_PROBE_REFRESH_MODE_ON_AWAKE: _ClassVar[
        ReflectionProbeRefreshMode
    ]
    REFLECTION_PROBE_REFRESH_MODE_EVERY_FRAME: _ClassVar[
        ReflectionProbeRefreshMode
    ]
    REFLECTION_PROBE_REFRESH_MODE_VIA_SCRIPTING: _ClassVar[
        ReflectionProbeRefreshMode
    ]
...
REFLECTION_PROBE_TIME_SLICING_MODE_ALL_FACES_AT_ONCE: (
    ReflectionProbeTimeSlicingMode
)
REFLECTION_PROBE_TIME_SLICING_MODE_INDIVIDUAL_FACES: (
    ReflectionProbeTimeSlicingMode
)
REFLECTION_PROBE_TIME_SLICING_MODE_NO_TIME_SLICING: (
    ReflectionProbeTimeSlicingMode
)
...
class ReflectionProbeUpdate(_message.Message):
    ...
    def __init__(
        ...
        time_slicing_mode: _Optional[
            _Union[ReflectionProbeTimeSlicingMode, str]
        ] = ...,
        ...
        custom_baked_texture: _Optional[
            _Union[_identifiers_pb2.AssetIdentifier, _Mapping]
        ] = ...,
        baked_texture: _Optional[
            _Union[_identifiers_pb2.AssetIdentifier, _Mapping]
        ] = ...,
    ) -> None: ...
