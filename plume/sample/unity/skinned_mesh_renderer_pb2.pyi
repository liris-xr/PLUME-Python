...
class SkinnedMeshRendererUpdate(_message.Message):
    ...
    class BlendShapeWeights(_message.Message):
        ...
        weights: _containers.RepeatedCompositeFieldContainer[
    ...
    def __init__(
        ...
        bones: _Optional[
            _Union[SkinnedMeshRendererUpdate.Bones, _Mapping]
        ] = ...,
        blend_shape_weights: _Optional[
            _Union[SkinnedMeshRendererUpdate.BlendShapeWeights, _Mapping]
        ] = ...,
    ) -> None: ...
