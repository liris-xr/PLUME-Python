...
from plume.sample.unity.urp import rendering_pb2 as _rendering_pb2
...
class AdditionalCameraDataUpdate(_message.Message):
    ...
    VOLUME_TRIGGER_FIELD_NUMBER: _ClassVar[int]
    ...
    volume_trigger: _identifiers_pb2.ComponentIdentifier
