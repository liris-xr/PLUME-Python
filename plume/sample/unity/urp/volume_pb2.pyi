...
class VolumeUpdate(_message.Message):
    __slots__ = ("component", "is_global", "colliders", "blend_distance", "weight", "priority", "shared_profile")
    ...
    def __init__(self, component: _Optional[_Union[_identifiers_pb2.ComponentIdentifier, _Mapping]] = ..., is_global: bool = ..., colliders: _Optional[_Union[VolumeUpdate.Colliders, _Mapping]] = ..., blend_distance: _Optional[float] = ..., weight: _Optional[float] = ..., priority: _Optional[float] = ..., shared_profile: _Optional[_Union[_identifiers_pb2.AssetIdentifier, _Mapping]] = ...) -> None: ...
