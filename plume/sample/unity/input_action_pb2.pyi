...
class InputActionType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    INPUT_ACTION_TYPE_VALUE: _ClassVar[InputActionType]
    INPUT_ACTION_TYPE_BUTTON: _ClassVar[InputActionType]
    INPUT_ACTION_TYPE_PASSTHROUGH: _ClassVar[InputActionType]
INPUT_ACTION_TYPE_VALUE: InputActionType
INPUT_ACTION_TYPE_BUTTON: InputActionType
INPUT_ACTION_TYPE_PASSTHROUGH: InputActionType

class InputAction(_message.Message):
    __slots__ = ("name", "binding_paths", "type", "boolean", "integer", "float", "double", "vector2", "vector3", "quaternion", "button")
