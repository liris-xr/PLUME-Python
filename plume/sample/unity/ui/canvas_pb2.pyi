...
class CanvasUpdate(_message.Message):
    __slots__ = ("component", "render_mode", "scale_factor", "reference_pixels_per_unit", "override_pixel_perfect", "vertex_color_always_gamma_space", "pixel_perfect", "plane_distance", "override_sorting", "sorting_order", "target_display", "sorting_layer_id", "additional_shader_channels", "sorting_layer_name", "update_rect_transform_for_standalone", "world_camera", "normalized_sorting_grid_size")
    COMPONENT_FIELD_NUMBER: _ClassVar[int]
