...
class RectTransformUpdate(_message.Message):
    ...
    def __init__(
        ...
        anchor_min: _Optional[_Union[_vector2_pb2.Vector2, _Mapping]] = ...,
        anchor_max: _Optional[_Union[_vector2_pb2.Vector2, _Mapping]] = ...,
        anchored_position: _Optional[
            _Union[_vector2_pb2.Vector2, _Mapping]
        ] = ...,
        size_delta: _Optional[_Union[_vector2_pb2.Vector2, _Mapping]] = ...,
        pivot: _Optional[_Union[_vector2_pb2.Vector2, _Mapping]] = ...,
    ) -> None: ...
