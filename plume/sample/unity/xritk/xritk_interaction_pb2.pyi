...
class XRITKInteraction(_message.Message):
    ...
    def __init__(self, interactable: _Optional[_Union[_identifiers_pb2.ComponentIdentifier, _Mapping]] = ..., interactor: _Optional[_Union[_identifiers_pb2.ComponentIdentifier, _Mapping]] = ..., type: _Optional[_Union[XRITKInteractionType, str]] = ...) -> None: ...
