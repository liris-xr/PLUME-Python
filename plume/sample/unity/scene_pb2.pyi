...
class LoadScene(_message.Message):
    ...
    mode: LoadSceneMode
    def __init__(self, scene: _Optional[_Union[_identifiers_pb2.SceneIdentifier, _Mapping]] = ..., mode: _Optional[_Union[LoadSceneMode, str]] = ...) -> None: ...

class UnloadScene(_message.Message):
    __slots__ = ("scene",)
    SCENE_FIELD_NUMBER: _ClassVar[int]
    scene: _identifiers_pb2.SceneIdentifier
    def __init__(self, scene: _Optional[_Union[_identifiers_pb2.SceneIdentifier, _Mapping]] = ...) -> None: ...
