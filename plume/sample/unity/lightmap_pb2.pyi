...
class LightmapsUpdate(_message.Message):
    ...
    def __init__(
        self,
        lightmaps_mode: _Optional[_Union[LightmapsMode, str]] = ...,
        lightmaps_data: _Optional[
            _Iterable[_Union[LightmapData, _Mapping]]
        ] = ...,
    ) -> None: ...

class LightmapData(_message.Message):
    __slots__ = (
        "lightmap_color_texture",
        "lightmap_dir_texture",
        "lightmap_shadow_mask_texture",
    )
    ...
    def __init__(
        self,
        lightmap_color_texture: _Optional[
            _Union[_identifiers_pb2.AssetIdentifier, _Mapping]
        ] = ...,
        lightmap_dir_texture: _Optional[
            _Union[_identifiers_pb2.AssetIdentifier, _Mapping]
        ] = ...,
        lightmap_shadow_mask_texture: _Optional[
            _Union[_identifiers_pb2.AssetIdentifier, _Mapping]
        ] = ...,
    ) -> None: ...
