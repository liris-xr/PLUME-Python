...
class LightmapData(_message.Message):
    __slots__ = ("lightmap_color_texture", "lightmap_dir_texture", "lightmap_shadow_mask_texture")
    LIGHTMAP_COLOR_TEXTURE_FIELD_NUMBER: _ClassVar[int]
    LIGHTMAP_DIR_TEXTURE_FIELD_NUMBER: _ClassVar[int]
    LIGHTMAP_SHADOW_MASK_TEXTURE_FIELD_NUMBER: _ClassVar[int]
    lightmap_color_texture: _identifiers_pb2.AssetIdentifier
    lightmap_dir_texture: _identifiers_pb2.AssetIdentifier
    lightmap_shadow_mask_texture: _identifiers_pb2.AssetIdentifier
    def __init__(self, lightmap_color_texture: _Optional[_Union[_identifiers_pb2.AssetIdentifier, _Mapping]] = ..., lightmap_dir_texture: _Optional[_Union[_identifiers_pb2.AssetIdentifier, _Mapping]] = ..., lightmap_shadow_mask_texture: _Optional[_Union[_identifiers_pb2.AssetIdentifier, _Mapping]] = ...) -> None: ...
