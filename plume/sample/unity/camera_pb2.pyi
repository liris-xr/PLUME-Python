...
from plume.sample.unity import rendering_pb2 as _rendering_pb2
from plume.sample.common import vector2_pb2 as _vector2_pb2
from plume.sample.common import vector3_pb2 as _vector3_pb2
from plume.sample.common import matrix4x4_pb2 as _matrix4x4_pb2
from plume.sample.common import color_pb2 as _color_pb2
from plume.sample.common import rect_pb2 as _rect_pb2
...
class CameraStereoTargetEyeMask(
...
class CameraUpdate(_message.Message):
    __slots__ = (
        ...
        "force_into_render_texture",
        "orthographic_size",
        "orthographic",
        "opaque_sort_mode",
        "transparency_sort_mode",
        "transparency_sort_axis",
        "depth",
        "aspect",
        "culling_mask",
        "event_mask",
        "layer_cull_spherical",
        "camera_type",
    ...
    TARGET_TEXTURE_FIELD_NUMBER: _ClassVar[int]
    ...
    USE_JITTERED_PROJECTION_MATRIX_FOR_TRANSPARENT_RENDERING_FIELD_NUMBER: (
        _ClassVar[int]
    )
    ...
    target_texture: _identifiers_pb2.AssetIdentifier
    target_display: int
    ...
    def __init__(
        ...
        field_of_view: _Optional[float] = ...,
        rendering_path: _Optional[
            _Union[_rendering_pb2.RenderingPath, str]
        ] = ...,
        allow_hdr: bool = ...,
        allow_msaa: bool = ...,
        allow_dynamic_resolution: bool = ...,
        force_into_render_texture: bool = ...,
        orthographic_size: _Optional[float] = ...,
        orthographic: bool = ...,
        opaque_sort_mode: _Optional[
            _Union[_rendering_pb2.OpaqueSortMode, str]
        ] = ...,
        transparency_sort_mode: _Optional[
            _Union[_rendering_pb2.TransparencySortMode, str]
        ] = ...,
        transparency_sort_axis: _Optional[
            _Union[_vector3_pb2.Vector3, _Mapping]
        ] = ...,
        depth: _Optional[float] = ...,
        aspect: _Optional[float] = ...,
        culling_mask: _Optional[int] = ...,
        event_mask: _Optional[int] = ...,
        layer_cull_spherical: bool = ...,
        camera_type: _Optional[int] = ...,
        layer_cull_distances: _Optional[
            _Union[CameraLayerCullDistances, _Mapping]
        ] = ...,
        use_occlusion_culling: bool = ...,
        culling_matrix: _Optional[
            _Union[_matrix4x4_pb2.Matrix4x4, _Mapping]
        ] = ...,
        background_color: _Optional[_Union[_color_pb2.Color, _Mapping]] = ...,
        clear_flags: _Optional[int] = ...,
        depth_texture_mode: _Optional[int] = ...,
        clear_stencil_after_lighting_pass: bool = ...,
        use_physical_properties: bool = ...,
        sensor_size: _Optional[_Union[_vector2_pb2.Vector2, _Mapping]] = ...,
        lens_shift: _Optional[_Union[_vector2_pb2.Vector2, _Mapping]] = ...,
        focal_length: _Optional[float] = ...,
        gate_fit: _Optional[_Union[CameraGateFitMode, str]] = ...,
        rect: _Optional[_Union[_rect_pb2.Rect, _Mapping]] = ...,
        pixel_rect: _Optional[_Union[_rect_pb2.Rect, _Mapping]] = ...,
        target_texture: _Optional[
            _Union[_identifiers_pb2.AssetIdentifier, _Mapping]
        ] = ...,
        target_display: _Optional[int] = ...,
        world_to_camera_matrix: _Optional[
            _Union[_matrix4x4_pb2.Matrix4x4, _Mapping]
        ] = ...,
        projection_matrix: _Optional[
            _Union[_matrix4x4_pb2.Matrix4x4, _Mapping]
        ] = ...,
        non_jittered_projection_matrix: _Optional[
            _Union[_matrix4x4_pb2.Matrix4x4, _Mapping]
        ] = ...,
        use_jittered_projection_matrix_for_transparent_rendering: bool = ...,
        stereo_separation: _Optional[float] = ...,
        stereo_convergence: _Optional[float] = ...,
        stereo_target_eye: _Optional[
            _Union[CameraStereoTargetEyeMask, str]
        ] = ...,
    ) -> None: ...
