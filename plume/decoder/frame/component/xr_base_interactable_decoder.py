...
class XRBaseInteractableCreateDecoder(FrameDataDecoder[XRBaseInteractableCreate]):
...
class XRBaseInteractableUpdateDecoder(FrameDataDecoder[XRBaseInteractableUpdate]):
    def decode(self, frame: Frame, data: XRBaseInteractableUpdate):
        interactable = get_or_create_component(frame, data.component, XRBaseInteractable)
...
class XRBaseInteractableDestroyDecoder(FrameDataDecoder[XRBaseInteractableDestroy]):
