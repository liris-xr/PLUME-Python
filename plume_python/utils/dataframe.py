...
def world_transforms_to_dataframe(world_transforms: list[TimestampedTransform]) -> pd.DataFrame:
    ...
    for world_transform in tqdm(world_transforms, desc="Creating dataframe"):
        ...
        world_transform_data.append({"timestamp": world_transform.timestamp,
