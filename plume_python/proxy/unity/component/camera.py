...
from plume_python.proxy.common.matrix4x4 import Matrix4x4
...
class Camera(Component):
    ...
    def deepcopy(self) -> Camera:
        return Camera(
            ...
            rendering_path=self._rendering_path,
            allow_hdr=self._allow_hdr,
            allow_msaa=self._allow_msaa,
            allow_dynamic_resolution=self._allow_dynamic_resolution,
            force_into_render_texture=self._force_into_render_texture,
            ...
            layer_cull_spherical=self._layer_cull_spherical,
            ...
            use_physical_properties=self._use_physical_properties,
            sensor_size=self._sensor_size.deepcopy() if self._sensor_size else None,
            lens_shift=self._lens_shift.deepcopy() if self._lens_shift else None,
            ...
            stereo_target_eye=self._stereo_target_eye,
        )